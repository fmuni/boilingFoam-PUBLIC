...
Type Foam::Boiling::isoAdvection::faceValue
(
...
template<typename Type>
void Foam::Boiling::isoAdvection::setFaceValue
(
...
void Foam::Boiling::isoAdvection::limitFluxes
(
    const SpType& Sp,
    const SuType& Su
)
...
template<class SpType, class SuType>
void Foam::Boiling::isoAdvection::boundFlux
(
...
template<class SpType, class SuType>
void Foam::Boiling::isoAdvection::advect(const SpType& Sp, const SuType& Su)
{
    DebugInFunction << endl;
