...
Foam::Boiling::isoAdvection::isoAdvection
(
...
void Foam::Boiling::isoAdvection::setProcessorPatches()
{
...
void Foam::Boiling::isoAdvection::extendMarkedCells
(
    bitSet& markedCell
) const
{
...
void Foam::Boiling::isoAdvection::timeIntegratedFlux()
{
    // Get time step
...
void Foam::Boiling::isoAdvection::setDownwindFaces
(
    const label celli,
...
Foam::scalar Foam::Boiling::isoAdvection::netFlux
(
...
Foam::DynamicList<Foam::label>  Foam::Boiling::isoAdvection::syncProcPatches
(
...
void Foam::Boiling::isoAdvection::checkIfOnProcPatch(const label facei)
{
    if (!mesh_.isInternalFace(facei))
    {
...
void Foam::Boiling::isoAdvection::applyBruteForceBounding()
{
...
void Foam::Boiling::isoAdvection::writeSurfaceCells() const
{
...
void Foam::Boiling::isoAdvection::writeIsoFaces
(
